...
const StatsBar: React.FC = () => {
  const stats = [
    { value: "56+", label: "Customers visit app every month" },
    { value: "10K+", label: "Total downloads of our app" },
    { value: "156K", label: "Total Members of App Users" },
    { value: "4.9", label: "Satisfaction rate from our customers" },
  ];
